...
- ✅ AI Technical Insights: tabella `technical_insights`, repository, endpoint n8n (`/api/n8n/technical-context.php` per prompt + `/api/n8n/ai_insights.php` per salvataggio) ed endpoint frontend `/api/ai/technical-insights.php` per mostrare gli ultimi insight
