...
try {
    ...
    $top_holdings = array_map(function($holding) use ($total_market_value, $insightMap) {
        ...
        return [
            ...
            'hist_vol_90d' => $holding['hist_vol_90d'] ?? null,
            ...
            // Fibonacci levels
            'fib_low' => $holding['fib_low'] ?? null,
            'fib_high' => $holding['fib_high'] ?? null,
            'fib_23_6' => $holding['fib_23_6'] ?? null,
            'fib_38_2' => $holding['fib_38_2'] ?? null,
            'fib_50_0' => $holding['fib_50_0'] ?? null,
            'fib_61_8' => $holding['fib_61_8'] ?? null,
            'fib_78_6' => $holding['fib_78_6'] ?? null,
            'fib_23_6_dist_pct' => $holding['fib_23_6_dist_pct'] ?? null,
            'fib_38_2_dist_pct' => $holding['fib_38_2_dist_pct'] ?? null,
            'fib_50_0_dist_pct' => $holding['fib_50_0_dist_pct'] ?? null,
            'fib_61_8_dist_pct' => $holding['fib_61_8_dist_pct'] ?? null,
            'fib_78_6_dist_pct' => $holding['fib_78_6_dist_pct'] ?? null,
            // Bollinger Bands dettagli
            'bb_middle' => $holding['bb_middle'] ?? null,
            'bb_upper' => $holding['bb_upper'] ?? null,
            'bb_lower' => $holding['bb_lower'] ?? null,
            'bb_width_pct' => $holding['bb_width_pct'] ?? null,
            // Range dettagliati
            'range_1m_min' => $holding['range_1m_min'] ?? null,
            'range_1m_max' => $holding['range_1m_max'] ?? null,
            'range_1m_percentile' => $holding['range_1m_percentile'] ?? null,
            'range_3m_min' => $holding['range_3m_min'] ?? null,
            'range_3m_max' => $holding['range_3m_max'] ?? null,
            'range_3m_percentile' => $holding['range_3m_percentile'] ?? null,
            'range_6m_min' => $holding['range_6m_min'] ?? null,
            'range_6m_max' => $holding['range_6m_max'] ?? null,
            'range_6m_percentile' => $holding['range_6m_percentile'] ?? null,
            'range_1y_min' => $holding['range_1y_min'] ?? null,
            'range_1y_max' => $holding['range_1y_max'] ?? null,
            // Volume e liquidità
            'vol_avg_20d' => $holding['vol_avg_20d'] ?? null,
            'vol_ratio_current_20d' => $holding['vol_ratio_current_20d'] ?? null,
            // SMA (Simple Moving Averages)
            'sma9' => $holding['sma9'] ?? null,
            'sma21' => $holding['sma21'] ?? null,
            'sma50' => $holding['sma50'] ?? null,
            'sma200' => $holding['sma200'] ?? null,
            // Intraday
            'previous_close' => $holding['previous_close'] ?? null,
